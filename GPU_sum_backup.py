...
def GPU_batch_firstlayer(P,Q,RW,X,activation):
...
def sum_perms_multilayer(Ws:list,x,permseqs,GPU_batch_func):
	W=Ws[0]
	m,n,d=W.shape
	X=jnp.repeat(jnp.expand.dims(x,axis=0),m,axis=0)
	sum_perms_instancebatch(W,X,permseqs,GPU_batch_func)
