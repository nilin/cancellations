...
batch.genprofile1=lambda prevoutputs: example.getdefaultprofile().butwith(n=4,adjusttargetsamples=1000,samples_train=10000,iterations=1000)


batch.task2=example.main
batch.genprofile2=lambda prevoutputs: example.getdefaultprofile().butwith(learnerchoice='ASNN2',n=4)
